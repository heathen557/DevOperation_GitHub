...
datas[0] = {"nodeid":"1","nodename":"平台","path":"/1","remark":"初始节点"};
var selectPath;
var allTableData =[];
var sameorg;
//获取选中的id
	 ...
	 //var param = $("#myeditorgform").serialize();
	  //  console.log('myeditorgform:'+param);
	    $.ajax({  
	           ...
	           data:{deletenodeid : deletenodeid},
	           dataType: 'json',  
	          error : function() {
	               alert('请求失败！ ');
	           },
...
//					
//					$("#txt_lastlevel").append("<option value='" + String(i) + "'>" + orglevel[i-1]+ "</option>");
//				}
				$("#txt_lastlevel").append("<option value='" + String(count-1) + "'>" + orglevel[count-2]+ "</option>");
...
//		                  console.log("保存返回的数据:"+JSON.stringify(data));
		        	   for (var i = 0; i < data.rows.length; i++) {
							$("#txt_lastorgname").append("<option value='" +data.rows[i] +"'>" + data.rows[i]+ "</option>");
						}
		           }
	...
	$table.bootstrapTable('destroy');
		...
		$table.bootstrapTable({
			...
			[
		        ...
		        {field:"nodeid",title:"节点ID",align:"center",valign:"middle",sortable:"false" ,visible:false},
				{field:"nodename",title:"机构",align:"center",valign:"middle",sortable:"false"},
				{field:"path",title:"级别",align:"center",valign:"middle",sortable:"false",visible:false},
				{field:"remark",title:"备注",align:"center",valign:"middle",sortable:"false",visible:false},
//				{
//				       field: 'operate',
//				       title: '操作',
//				       align: 'center',
...
function InitSubTable(index, row, $detail) {
    ...
    $(cur_table).bootstrapTable({
        ...
        onCheck:function (row){
        	...
        	var level = count +1;	
        	$("#txt_addorglevel").append("<option value='" + String(count) + "'>" + orglevel[count]+ "</option>");
        },
