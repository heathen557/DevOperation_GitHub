...
//    private String tokenHeader;
     ...
     * .. 匹配任意数量的参数.
     */
//    @Pointcut("execution(public * onenet.DevOperation.sqlservice.*(..))  && @annotation(onenet.DevOperation.log.MyLog)")
//    public void webLog() {
//    }
 
    @AfterReturning(returning="var"  
            , pointcut="execution(public * onenet.DevOperation.sqlservice.*.*(..))&& @annotation(onenet.DevOperation.log.MyLog)")
    public void doafterReturning(JoinPoint  joinPoint,Object var) throws Throwable {
        ...
        OperationLog operateLog = new OperationLog(module, JSON.toJSONString(content), "admin", ByteConvertUtils.sysFormatStrTime(), business);
