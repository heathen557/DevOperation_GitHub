...
public class OrgSettingServiceImpl implements OrgSettingService{
	...
	@Override
	@MyLog(description = "编辑停车位属性", module = OperateModule.OrgSetting, opType = OperateType.modify,
    primaryKeyName = "attrid", primaryKeySort = 7, primaryKeyBelongClass = DevAttr.class)
	...
	@Override
	@MyLog(description = "编辑组织机构属性", module = OperateModule.OrgSetting, opType = OperateType.modify,
		    primaryKeyName = "rowid", primaryKeySort = 0, primaryKeyBelongClass = Orgnization.class)
			public Orgnization editOrg(String sameorgname, String  curpath, String  path,String  orgnewname,String nodeid, String  remark) {
				
	 	orgdao.updatePathBynewpath( curpath, path,curpath);
    	//更新nodeID
    	orgdao.updateorgbynodeid(orgnewname,remark, nodeid);
//    	orgdao.updateorgbynodeid( orgname, path, remark , nodeid);
    	if(sameorgname != null) { //重复,删除
    		//
	...
	@Override
	@MyLog(description = "增加停车位", module = OperateModule.OrgSetting, opType = OperateType.create,
    primaryKeyName = "attrid", primaryKeySort = 0, primaryKeyBelongClass = DevAttr.class)
	public DevAttr addBerth(String berthl, String operator, String protocol, String imeil, String devicetype, String imsil,
			String regcode, String nextnodeid,String path) {
	...
	@Override
	@MyLog(description = "增加组织机构", module = OperateModule.OrgSetting, opType = OperateType.create,
    primaryKeyName = "rowid", primaryKeySort = 0, primaryKeyBelongClass = Orgnization.class)
	...
	@Override
	@MyLog(description = "删除停车位", module = OperateModule.OrgSetting, opType = OperateType.delete,
    primaryKeyName = "attrid", primaryKeySort = 0, primaryKeyBelongClass = DevAttr.class)
	...
	@Override
	@MyLog(description = "删除组织", module = OperateModule.OrgSetting, opType = OperateType.delete,
    primaryKeyName = "rowid", primaryKeySort = 0, primaryKeyBelongClass = Orgnization.class)
