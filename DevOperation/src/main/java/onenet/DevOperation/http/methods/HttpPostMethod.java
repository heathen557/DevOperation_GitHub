	...
	public void setEntity(Object json) {
		if (json != null) {
			if (json instanceof String) {
				if(JsonUtil.isJSONValid((String)json)) {
					((HttpPost) httpRequestBase).setEntity(new StringEntity((String)json,
...
//		if (json != null) {
//			if (json instanceof String) {
//				((HttpPost) httpRequestBase).setEntity(new StringEntity(json,
//						ContentType.APPLICATION_JSON));
//			}
//		
//			
